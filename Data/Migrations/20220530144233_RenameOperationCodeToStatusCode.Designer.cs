...
namespace ShiftWorx.Migrations
{
    ...
    [Migration("20220530144233_RenameOperationCodeToStatusCode")]
    partial class RenameOperationCodeToStatusCode
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShiftWorx.Models.Job", b =>
                {
                    ...
                    b.Property<DateTime?>("EstmatedStartTime")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("ShiftWorx.Models.JobAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("AttachedOperationCodeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AttachedOperationCodeId");
            ...
            modelBuilder.Entity("ShiftWorx.Models.OperationCodeAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("OperationCodeAttachment");
                });
            ...
            modelBuilder.Entity("ShiftWorx.Models.JobAttachment", b =>
                {
                    ...
                    b.HasOne("ShiftWorx.Models.StatusCode", "AttachedOperationCode")
                        .WithMany()
                        .HasForeignKey("AttachedOperationCodeId");
                    ...
                    b.Navigation("AttachedOperationCode");
            ...
            modelBuilder.Entity("ShiftWorx.Models.OperationCodeAttachment", b =>
                {
                    ...
                    b.HasOne("ShiftWorx.Models.StatusCode", "OperationCode")
                        .WithMany()
