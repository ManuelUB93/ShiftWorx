...
namespace ShiftWorx.Migrations
{
    ...
    [Migration("20220802183032_IdentityAuthModel")]
    partial class IdentityAuthModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShiftWorx.Models.IdentityAuth", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ShiftWorx.Models.Layout", b =>
                {
                    b.HasOne("ShiftWorx.Models.Machine", null)
                        .WithMany("Layouts")
                        .HasForeignKey("MachineId");
                });
            ...
            modelBuilder.Entity("ShiftWorx.Models.Panel", b =>
                {
                    b.HasOne("ShiftWorx.Models.Layout", null)
                        .WithMany("Panels")
